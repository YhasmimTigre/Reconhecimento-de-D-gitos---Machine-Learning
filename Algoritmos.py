...
class PLA ():
    ...
    """Classe Perceptron Learning Algorithm
        ...
        Métodos:
        - acuracia: retorna a acurácia do modelo
        - __construtor_PCI: constrói o conjunto de pontos classificados incorretamente
        - fit: treina o modelo
        - predict: retorna as predições
        - get_w: retorna o vetor de pesos
        - set_w: seta um novo vetor de pesos
...
class Reg_Log ():
    ...
    def __init__ (self, eta = 0.1, n_int = 1000, tam_batch = 50) -> None:
        self.eta = eta
        self.n_int = n_int
